    ...
    <Drawer open={isOpen} onOpenChange={onClose}>
      <DrawerContent className="max-h-[85vh]">
        <DrawerHeader className="text-center px-6 pt-6">
          <DrawerTitle>Place an order</DrawerTitle>
          <DrawerDescription>
          ...
          <div className="grid gap-6 py-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant="outline"
                  onClick={() => document.getElementById("image-upload-drawer")?.click()}
                >
                  <ImageIcon className="mr-2 h-4 w-4" />
                  Upload Images
                </Button>
                <input
                  id="image-upload-drawer"
                  type="file"
                  accept="image/*"
                  multiple
                  className="hidden"
            ...
            {/* <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant="outline"
                  onClick={() => document.getElementById("video-upload-drawer")?.click()}
                >
                  <Video className="mr-2 h-4 w-4" />
                  Upload Videos
                </Button>
                <input
                  id="video-upload-drawer"
                  type="file"
                  accept="video/*"
                  multiple
                  className="hidden"
